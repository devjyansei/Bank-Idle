...
public class PlayerTriggerHandler : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (MoneyBag.Instance.moneyOnPlayer < MoneyBag.Instance.moneyLimit )// yerden alacagý para moneylimiti geçmemeli
            {
                if (other.gameObject.GetComponentInParent<SecurityManager>() != null)
                {
                    ...
                    if (tempManager.createdMoney + MoneyBag.Instance.moneyOnPlayer < MoneyBag.Instance.moneyLimit)
                    {
